...
-- Consultando novamente uma Complete Refreshed Materialized View após o DML (Oracle zerou a tabela e atualizou toda (Maior custo de performance)
...
-- É uma MV Complexa (pois tem subconsulta)
